...
const Products = () => {
  ...
  return (
<div className="min-h-screen bg-white">
      {/* ADD HELMET COMPONENT HERE */}
      <Helmet>
        <title>Our Products - BAKLIV Pharmaceutical Excellence</title>
        <meta 
          name="description" 
          content="Browse our range of high-quality pharmaceutical products. BAKLIV offers trusted medicines with 25 years of industry expertise." 
        />
        <meta name="keywords" content="pharmaceutical products, medicines, healthcare products, BAKLIV products" />
        <link rel="canonical" href="https://bakliv.com/products" />
        
        {/* Open Graph Tags */}
        <meta property="og:title" content="Our Products - BAKLIV Pharmaceutical Excellence" />
        <meta 
          property="og:description" 
          content="Browse our range of high-quality pharmaceutical products. BAKLIV offers trusted medicines with 25 years of industry expertise." 
        />
        <meta property="og:url" content="https://bakliv.com/products" />
        <meta property="og:type" content="website" />
        
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Our Products - BAKLIV Pharmaceutical Excellence" />
        <meta 
      ...
      {/* Hero Section with Search - YOUR EXISTING UI STARTS HERE */}
      <section className="bg-[#181d54] text-white py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-5xl font-light mb-8 tracking-wide text-center">Our Products</h1>
